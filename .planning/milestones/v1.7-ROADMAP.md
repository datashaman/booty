...
- 2+ markers (Severity + Sentry) for incident heuristics; first line = goal for CLI text

**Issues Resolved:**
- Plan format enables Builder to consume; handoff_to_builder, touch_paths, commands, acceptance per step

**Issues Deferred:**
- PLAN-22: Builder execution verification until Builder integrates and consumes plan (future milestone)

**Technical Debt:**
- None — no stubs or placeholders in planner source
