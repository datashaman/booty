...
Plans:
- [ ] 27-01-PLAN.md — Plan schema (Pydantic) and storage (get_planner_state_dir, save_plan)
- [ ] 27-02-PLAN.md — PlannerConfig, .booty.yml planner block, env overrides
- [ ] 27-03-PLAN.md — Webhook agent:plan branch, PlannerJob, planner worker
- [ ] 27-04-PLAN.md — booty plan --issue, booty plan --text CLI
