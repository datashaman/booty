...
Plans:
- [ ] 31-01-PLAN.md — Cache primitives: schema metadata, input_hash, plan_hash, load_plan, find_cached_issue_plan
- [ ] 31-02-PLAN.md — Wire worker and CLI plan_issue to check cache before LLM
- [ ] 31-03-PLAN.md — Ad-hoc cache with hash index; wire CLI plan_text
