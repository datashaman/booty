...
Plans:
- [ ] 28-01-PLAN.md — PlannerInput model, normalizers (GitHub issue, CLI text), incident detection
- [ ] 28-02-PLAN.md — get_repo_context (optional default branch + tree)
- [ ] 28-03-PLAN.md — Wire worker and CLI to normalizers
