...
Plans:
- [ ] 37-01-PLAN.md — Module skeleton, ReviewerConfig, BootyConfigV1.reviewer
- [ ] 37-02-PLAN.md — create_reviewer_check_run in checks.py
- [ ] 37-03-PLAN.md — post_reviewer_comment in comments.py
...
Plans:
- [ ] 38-01-PLAN.md — ReviewerJob, ReviewerQueue (dedup, cancel)
- [ ] 38-02-PLAN.md — pull_request webhook wiring for agent PRs
- [ ] 38-03-PLAN.md — Reviewer runner stub, lifespan
...
Plans:
- [ ] 39-01-PLAN.md — Schema, engine, Magentic prompt, block_on mapping
- [ ] 39-02-PLAN.md — Runner integration, diff fetch, format comment, check + post
...
Plans:
- [ ] 40-01-PLAN.md — reviewer_check_success helper, Verifier promotion gate
...
Plans:
- [ ] 41-01-PLAN.md — Fail-open handling, reviewer metrics module
- [ ] 41-02-PLAN.md — Success-path metrics, structured logs
- [ ] 41-03-PLAN.md — booty reviewer status CLI, docs
