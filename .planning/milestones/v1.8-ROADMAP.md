...
Plans:
- [ ] 35-01-PLAN.md — Architect cache primitives (plan_hash reuse, find/save)
- [ ] 35-02-PLAN.md — Comment diff helper (get_plan_comment_body, update_if_changed)
- [ ] 35-03-PLAN.md — Main flow integration (cache check, save, diff-before-update)
