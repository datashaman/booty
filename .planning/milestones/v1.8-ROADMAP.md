...
Plans:
- [ ] 36-01-PLAN.md — Artifact persistence, event emission
- [ ] 36-02-PLAN.md — Builder handoff, webhook changes
- [ ] 36-03-PLAN.md — Metrics (plans_reviewed, plans_rewritten, architect_blocks, cache_hits)
- [ ] 36-04-PLAN.md — CLI architect status, architect review
