...
Plans:
- [ ] 32-01-PLAN.md — ArchitectConfig, .booty.yml architect block, get_architect_config, ArchitectConfigError, env overrides
- [ ] 32-02-PLAN.md — ArchitectInput, ArchitectResult, process_architect_input (pass-through)
- [ ] 32-03-PLAN.md — Planner worker integration, GitHub helpers (comments, label), Architect flow
...
---
*Created: 2026-02-17 as part of v1.8 milestone start*
