...
Plans:
- [ ] 33-01-PLAN.md — Structural validation, path consistency, risk recomputation
- [ ] 33-02-PLAN.md — Ambiguity and overreach detection and rewrite
- [ ] 33-03-PLAN.md — Worker integration, block flow, < 5s
