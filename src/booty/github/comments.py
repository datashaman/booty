...
def post_failure_comment(
    ...
    *,
    ...
    Args:
        ...
        pr_created: If True, mention that a draft PR was opened. If False (pipeline
            crashed before PR creation), omit that line.
    ...
    try:
        ...
        pr_note = (
            ...
            if pr_created
            else "\n\nNo PR was created — the pipeline failed before commit/push."
        )
